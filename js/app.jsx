  ...
  render(){
    return <article className="main">
            <div id="home" onMouseEnter={this.handleOnMouseEnter1}>
              { this.state.showTextfield_home ? <div className="textfield"><h1>{homeTextHeading}</h1><p>My name is Bartosz Mylka and this is my first project as a Front-End Developer. Feel free to have a look on it but its not finished yet. In my <a href="#living_room">living room</a> and <a href="#office">office</a> you will find more Information about me. You can also download my CV in <a download href="./pdf/Bartosz_Mylka_CV_ENG.pdf">English</a>, <a download href="./pdf/Bartosz_Mylka_CV_DE.pdf">German</a> or <a download href="./pdf/Bartosz_Mylka_CV_PL.pdf">Polish</a>.</p><div className="flags"><div className="uk"/><div className="germany"/><div className="poland"/></div></div> : null }
            </div>
